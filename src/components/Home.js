        ...
        <>
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={course1} alt="Card img" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Best Industry Leader</h5>
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={course4} alt="Card img" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Great Faculty & Infrastructure</h5>
                                <p className="card-text ">
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={course3} alt="Card imag" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Learn Courses Online</h5>
                                <p className="card-text">
                    ...
                    <div className="col-lg-3 mt-5" id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={course2} alt="Card imag" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Industrial Training</h5>
                                <p className="card-text">
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={mean} alt="Card img" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">MEAN Stack</h5>
                                <p className="card-text">
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={mern} alt="Card img" />
                            <div className="card-body">
                    ...
                    <div className="col-lg-3 mt-5 " id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={java} alt="Card imag" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Java</h5>
                                <p className="card-text">
                    ...
                    <div className="col-lg-3 mt-5" id="card-hover">
                        <div className="card">
                            <img className="card-img-top" src={python} alt="Card imag" />
                            <div className="card-body">
                                <h5 className="card-title font-weight-bold">Python</h5>
                                <p className="card-text">
            ...
            <div className="container-fluid" id="partner">
                <div className="row1">
                    ...
                    <p className="text-center mt-2 h4">PARTIAL LIST OF COMPANIES</p><br />

                    <div className="col-sm-12 col-lg-12 col-md-12" id="partner1">
                        <img src={partners1} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners2} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners3} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners4} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners5} alt="" className="card-hover img-thumbnail mr-2 mb-2" />

                    </div>


                    <div className=" col-lg-12  " id="partner1">
                        <img src={partners7} alt="" className="card-hover img-thumbnail mr-2 mb-2" />

                        <img src={partners9} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners10} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners11} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                        <img src={partners12} alt="" className="card-hover img-thumbnail mr-2 mb-2" />
                    </div>
